...
public class Main {
  ...
  public static void main(String[] args) {
    BufferedReader input = new BufferedReader(new InputStreamReader(System.in)); // BufferedReader is a class from java.io to read entire input with space 
    String inputLine = "";
    ...
    while (true) {
      ...
      } catch (IOException e) { // using BufferReader must handle IOException
      ...
      if (cmdParts[0].equalsIgnoreCase("Exit")) { // .equalsIgnoreCase() 
        break;
